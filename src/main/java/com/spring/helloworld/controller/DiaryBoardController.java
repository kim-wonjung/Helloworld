...
public class DiaryBoardController {
	...
	public void list(Model model, Integer page, Integer perPage, String folder_name, HttpServletRequest req,
		...
		if (folder_name == null || folder_name == "") { // folder 가 null 이거나 공백 일 경우
	         ...
	         if (d_date == null || d_date == "") {
	            ...
	            String[] DiaryFolderList = folderList.split(","); // , 로 쪼개서
	      ...
	      } else if (folder_name != null || folder_name != "") { // folder_name 이 null 이거나 공백이 아닐 경우
